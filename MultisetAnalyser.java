...
//				}
				...
				if (addTime >= limit) {
					System.out.print("Operation took longer than "+ ((double)(addTime))/Math.pow(10,9) + " secs to complete;");
					System.out.print("Operation progressed " + complete + " %;");
					early = true;
					break;
				}
			...
			if (!early)
				System.out.print(((double)(addTime)) / Math.pow(10, 9) + " sec;");
...
//				}
				...
				if (searchTime >= limit) {
					System.out.print("Operation took longer than "+ ((double)(searchTime))/Math.pow(10,9) + " secs to complete;");
					System.out.print("Operation progressed " + complete + " %;");
					early = true;
					break;
				}
			...
			if (!early)
				System.out.print(((double)(searchTime)) / Math.pow(10, 9) + " sec;");
...
//				}
				...
				if (removeTime >= limit) {
					System.out.print("Operation took longer than "+ ((double)(removeTime))/Math.pow(10,9) + " secs to complete;");
					System.out.print("Operation progressed " + complete + " %;");
					early = true;
					break;
				}
			...
			if(!early)
				System.out.print(((double)(removeTime)) / Math.pow(10, 9) + " sec;");
		}
	}
	...
	public void multisetAnalysis(){
		...
		String[] msName={"bst", "hash", "baltree"};
		String[] msSize={"10000","100000","1000000"};
		String[] args;
		System.out.println("Multiset name; size length; Scenario; Add time; Search time; Remove time;");
		for(int i=0; i<msName.length;i++){	
			for(int j=0;j<msSize.length;j++){
				//only addition
				System.out.println("");
			        System.out.print(msName[i]+";");
				System.out.print( msSize[j]+";");

				System.out.print("Scenario 1: (only addition) "+";");
...
//				System.out.println("size length: " + msSize[j]);
				...
				System.out.print(";;Scenario 2: (addition equals deletion) "+";");
...
//				System.out.println("size length: " + msSize[j]);
				...
				System.out.print(";;Scenario 3: (only deletion) "+";");
...
//				System.out.println("size length: " + msSize[j]);
				...
				System.out.print(";;Scenario 4: (Search > addition + deletion) 2N"+";");
...
//				System.out.println("size length: " + msSize[j]);
				...
				System.out.print(";;Scenario 4: (Search > addition + deletion) 3N"+";");
...
//				System.out.println("size length: " + msSize[j]);
				...
				System.out.print(";;Scenario 4: (Search > addition + deletion) 4N"+";");
	...
	private String[] scen4(String name, String size, String searchNo){
		...
		//System.out.print("Number of searches: "+ searchNo);
